...
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);{ќпредел€ет введенный мес€ц}
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month);{¬ыводит мес€ц}

IMPLEMENTATION
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
{—читываем первые три символа и присваиваем значение мес€ца}
VAR
  Ch1,Ch2,Ch3 : CHAR;
BEGIN{ReadMonth}
...
{¬ зависимости от значени€ переменой выводим нужный мес€ц}
VAR
  Ch1,Ch2,Ch3 : CHAR;
BEGIN {WriteMonth}
